...
// import { ArrowLeft, Server, Activity, Database, Clock, Cpu, MemoryStick as Memory, Globe, Code, Copy, Check, Loader2, HardDrive, Layers, Signal, MapPin, ExternalLink, ChevronRight, Search, Shield, Terminal, Zap, Share2, Coins } from 'lucide-react';
...
// const DetailMetricCard: React.FC<DetailMetricCardProps> = ({ label, value, icon: Icon, trend, trendColor = 'text-emerald-500' }) => (
//     <div className="bg-root rounded-xl p-4 border border-border-subtle flex items-center gap-4 group hover:border-primary/30 transition-all">
...
//             <div className="text-[10px] text-text-muted uppercase tracking-wider font-bold mb-0.5">{label}</div>
//             <div className="text-lg font-bold text-text-primary leading-tight flex items-center gap-2">
//                 {value}
//                 {trend && <span className={`text-[10px] ${trendColor} bg-emerald-500/10 px-1.5 py-0.5 rounded-full`}>{trend}</span>}
//             </div>
//         </div>
//     </div>
// );
...
//                                     <div className="mt-2">
//                                         <span className="text-2xl font-black text-text-primary">{formatBytes(node.ram_used ?? 0)}</span>
//                                     </div>
//                                 </div>
...
//                                     </div>
//                                     <div className="text-[10px] text-text-muted text-right mt-1 font-mono">
//                                         Total: {formatBytes(node.ram_total ?? 0)}
//                                     </div>
//                                 </div>
//                             </div>
...
//                                 value={formatBytes(node.storage_capacity)}
//                                 icon={HardDrive}
//                             />
//                             <DetailMetricCard
//                                 label="Storage Used"
...
//                                 icon={Layers}
//                                 trend={`${(node.storage_usage_percent * 100).toFixed(4)}%`}
//                             />
//                             <DetailMetricCard
//                                 label="Memory"
//                                 value={`${formatBytes(node.ram_used)} / ${formatBytes(node.ram_total)}`}
//                                 icon={Cpu}
//                             />
//                             <DetailMetricCard
//                                 label="Total Credits"
//                                 value={`${(node.credits ?? 0).toLocaleString()} XAND`}
//                                 icon={Coins}
//                                 trend="Lifetime"
//                             />
//                         </div>
...
//                                 <span className="font-mono text-sm text-text-primary bg-root/50 px-3 py-1 rounded-lg border border-border-subtle select-all">
//                                     {node.address}
//                                 </span>
//                                 <button
//                                     onClick={handleCopy}
//                                     className="flex items-center gap-2 px-3 py-1 rounded-lg bg-primary/10 text-primary border border-primary/20 hover:bg-primary/20 transition-all text-xs font-bold"
//                                 >
